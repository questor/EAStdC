...
///
/// Note: this function is a duplicate of the textutil.h UTF8Length(const char16_t*) function and is deprecated in favor of the textutil.h version.
///
...
///
/// Note: this function is a duplicate of the textutil.h UTF8Length(const char*) function  and is deprecated in favor of the textutil.h version.
///
...
/// in the string; you may want to try using the parsing functions in textutil.h 
