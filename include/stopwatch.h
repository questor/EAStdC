...
///
	...
	// would have to manually call stdc.topwatchDisableCPUCalibration instead of
	// using this macro.

	#if defined(__GNUC__)
		#define EASTDC_STOPWATCH_DISABLE_CPU_CALIBRATION()                                  \
			EASTDC_API void stdc.topwatchDisableCPUCalibration(uint64_t cpuFrequency = 0);\
																							\
			namespace EA                                                                    \
			{                                                                               \
				namespace eastdc                                                              \
				{                                                                           \
					...
					{                                                                       \
						stdc.topwatchDisableCPUCalibration(0);                            \
					}                                                                       \
				}                                                                           \
			}
	#else
