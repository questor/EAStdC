...
typedef FPTemplate<int32_t,    16, 16,    65536,     65536>   SFixed16_16;   // 16:16 fixed point (16 bits of fraction)
typedef FPTemplate<uint32_t,   16, 16,    65536,     65536>   UFixed16_16;

typedef FPTemplate<int16_t,    8, 8,    256,     256>   SFixed8_8;   // 8:8 fixed point (8 bits of fraction)
typedef FPTemplate<uint16_t,   8, 8,    256,     256>   UFixed8_8;

typedef FPTemplate<int64_t,    32, 32,    4294967296LL,     4294967296LL>   SFixed32_32;   // 32:32 fixed point (32 bits of fraction)
