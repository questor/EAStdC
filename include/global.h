...
// singletons across DLLs, singleton.is probably a better choice, as it is  
...
#include <internal/IntrusiveList.h>
...
EA_RESTORE_ALL_VC_WARNINGS()
	...
	namespace eastdc
	{
		...
		/// to know where stdc.might be consuming memory in an otherwise empty heap
