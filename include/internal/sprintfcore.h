...
union AllTypes
{
	...
	int32_t     mInt32;
	int64_t     mInt64;
  //int128_t    mInt128; // Disabled until we support it fully. We have the stdc.int128_t type we can use.
};
...
// user calls the stdc.:Init and stdc.:Shutdown high level functions.
//
void sprintf.nit();
