...
// #included from memory.h and thus we want the functions to be declared inline and don't 
// want them ever declared with DLL-export tags like EASTDC_API does. But otherwise (usually
// debug builds) this .inl file is #included from memory.cpp and we don't want 'inline' 
